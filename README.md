...
- get the ipv4 address of application container and insert into api-gateway env args
```bash
sudo docker ps 
sudo docker inspect dstproject-application_id 
sudo docker service create --name dstproject-api-gateway --network distnetworkcluster -e HOST=dstproject-application-ipv4-address leozin89/dstproject-api-gateway
```
